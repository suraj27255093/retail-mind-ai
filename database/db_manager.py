    ...
    def _seed_initial_data(cls) -> None:
        with cls.get_connection() as conn:
            ...
            if c.fetchone()[0] == 0:
                ...
                products = [
                    ("RM-BAR-101", "Aashirvaad Shuddh Chakki Atta 5kg", "Aashirvaad Atta", "Aashirvaad", "Grocery & Staples", "kg", 185.0, 205.0, 245.0, 195.0, 245.0, 245.0, 85, 15, "🟢 Healthy", "Nashik APMC Mandi", "ITC Wholesalers", 5, "1101", "2026-12-31", "A-12", today_ts, "FCA Info Web (fcainfoweb.nic.in)", "99% Verified Govt FCA"),
                    ("RM-BAR-102", "Fortune Sunlite Sunflower Oil 1L", "Fortune Oil", "Fortune", "Edible Oils", "litre", 115.0, 128.0, 155.0, 122.0, 155.0, 155.0, 45, 10, "🟢 Healthy", "Pune APMC Market", "Adani Wilmar Dist.", 5, "1512", "2026-11-15", "B-04", today_ts, "MSAMB APMC Portal (msamb.com)", "98% Verified MSAMB"),
                    ("RM-BAR-103", "Tata Salt Vacuum Evaporated 1kg", "Tata Salt", "Tata", "Grocery & Staples", "kg", 18.0, 22.0, 28.0, 20.0, 28.0, 28.0, 140, 20, "🟢 Healthy", "Nashik APMC Mandi", "Tata Consumer Products", 5, "2501", "2027-05-20", "A-02", today_ts, "eNAM Govt Portal (enam.gov.in)", "99% Verified eNAM"),
                    ("RM-BAR-104", "Amul Butter Pasteurised 500g", "Amul Butter", "Amul", "Dairy & Frozen", "pcs", 220.0, 242.0, 275.0, 230.0, 275.0, 275.0, 8, 12, "🔴 Critical", "Malegaon Wholesale APMC", "Amul Dairy Corp", 5, "0405", "2026-08-28", "C-01", today_ts, "Mumbai APMC Portal (mumbaiapmc.org)", "97% Verified Mumbai APMC"),
                    ("RM-BAR-105", "Sugar M-30 Premium Grade 1kg", "Sugar M-30", "Local Wholesale", "Grocery & Staples", "kg", 52.0, 56.0, 65.0, 54.0, 65.0, 65.0, 220, 30, "🟢 Healthy", "Malegaon Wholesale APMC", "Sahakar Sugar Mill", 5, "1701", "2027-01-10", "A-08", today_ts, "FCA Info Web (fcainfoweb.nic.in)", "99% Verified Govt FCA"),
                    ("RM-BAR-106", "Daawat Rozana Basmati Rice 1kg", "Daawat Rice", "Daawat", "Grocery & Staples", "kg", 54.0, 60.0, 68.0, 57.0, 68.0, 68.0, 150, 25, "🟢 Healthy", "Nashik APMC Mandi", "LT Foods Dist.", 5, "1006", "2027-06-30", "A-10", today_ts, "MSAMB APMC Portal (msamb.com)", "98% Verified MSAMB"),
                    ("RM-BAR-107", "Nestle Everyday Dairy Whitener 1kg", "Nestle Milk Powder", "Nestle", "Dairy & Frozen", "kg", 490.0, 530.0, 625.0, 510.0, 625.0, 625.0, 18, 10, "🟡 Low", "Pune APMC Market", "Nestle India Supplies", 12, "0402", "2026-09-15", "C-03", today_ts, "Mumbai APMC Portal (mumbaiapmc.org)", "96% Verified APMC"),
                    ("RM-BAR-108", "Cadbury Dairy Milk Silk 150g", "Dairy Milk Silk", "Cadbury", "Confectionery", "pcs", 132.0, 145.0, 175.0, 138.0, 175.0, 175.0, 60, 15, "🟢 Healthy", "Nashik APMC Mandi", "Mondelez India", 18, "1806", "2026-10-30", "D-05", today_ts, "MSAMB APMC Portal (msamb.com)", "97% Verified MSAMB")
                ]
                c.executemany("""
