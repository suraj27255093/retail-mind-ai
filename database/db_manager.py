        ...
        with cls.get_connection() as conn:
            ...
            if c.fetchone()[0] == 0:
                ...
                products = [
                    ...
                    ("RM-BAR-107", "Sugar M-30 Premium Grade 1kg", "Sugar M-30", "Local Wholesale", "Grocery & Staples", "kg", 44.0, 48.0, 53.0, 46.0, 53.0, 53.0, 220, 30, "🟢 Healthy", "Malegaon Wholesale APMC", "Sahakar Sugar Mill", 5, "1701", "2027-01-10", "A-08", today_ts, "FCA Info Web (fcainfoweb.nic.in)", "99% Verified Govt FCA"),
